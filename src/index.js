...
class Add extends React.Components{
	...
	render(){
		...
		return(
			<header class="header">
				<h1>todos</h1>
				<input class="new-todo" onkeydown={onkeydown} placeholder="What needs to be done?"/>
			</header>
		)
	}
	onkeydown(e){
...
//function render(){
//	ReactDOM.render(<Provider store={store}><App a={1}></App></Provider>,document.getElementById('root'));
//}
